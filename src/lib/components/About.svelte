		...
		<div class="grid items-center gap-16 lg:grid-cols-2">
			...
			<div class={visible ? 'animate-fade-up' : 'opacity-0'} style="animation-delay: 150ms;">
				...
				<p class="mb-6 leading-relaxed text-gray-400">
					Меня зовут Муртазо Халифаев. Каждый мой сад — это высказывание, а не проект по типовому
					решению. 18 лет я создавал пространства, которые невозможно спутать с чьими-либо другими.
				</p>

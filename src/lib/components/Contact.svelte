	...
	<div class="mx-auto max-w-6xl px-6">
		<div class="grid gap-16 lg:grid-cols-2">
			...
			<div class={visible ? 'animate-fade-up' : 'opacity-0'} style="animation-delay: 150ms;">
				{#if submitted}
					<div
						class="flex flex-col items-center justify-center bg-white p-16 text-center dark:bg-white/5"
					>
						<div
				...
				{:else}
					<form onsubmit={handleSubmit} class="space-y-5 bg-white p-8 dark:bg-white/5">
						<div>
